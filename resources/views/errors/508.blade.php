    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 80%; height:80%;" src="/images/508.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">Sorry, The server detected an infinite loop while processing the request.</span>
                </div>
                <br />
