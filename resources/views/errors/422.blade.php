    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 40%; height:40%;" src="/images/422.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">Sorry, The request was well-formed but was unable to be followed due to semantic errors. </span>
                </div>
                <br />
