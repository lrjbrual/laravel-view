    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 70%; height:70%;" src="/images/202.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">The request has been accepted for processing, but the processing has not been completed. </span>
                </div>
                <br />
