    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 60%; height:60%;" src="/images/412.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">Sorry, The server does not meet one of the preconditions that the requester put on the request. </span>
                </div>
                <br />
