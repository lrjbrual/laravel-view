    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 80%; height:80%;" src="/images/424.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">Sorry, The request failed due to failure of a previous request. </span>
                </div>
                <br />
