    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <!-- content -->
                <div>
                    <img style="width: 60%; height:60%;" src="/images/416.jpg">
                </div>
                <div>
                    <span class="error">ERROR: </span>
                    <span class="error-text">Sorry, The client has asked for a portion of the file, but the server cannot supply that portion. </span>
                </div>
                <br />
