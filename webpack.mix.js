...
var paths = {
    ...
    "bootstrap_tour":vendors + 'bootstrap-tour/',
    "tipso":vendors + 'tipso/'
};
    ...
    // bootstrap tour
    mix.copy(paths.bootstrap_tour + 'build/css/bootstrap-tour-standalone.css', destVendors + 'bootstrap-tour/css');
    mix.copy(paths.bootstrap_tour + 'build/js/bootstrap-tour-standalone.min.js', destVendors + 'bootstrap-tour/js');

    // tipso
    mix.copy(paths.tipso + 'src/tipso.min.css', destVendors + 'tipso/css');
    mix.copy(paths.tipso + 'src/tipso.min.js', destVendors + 'tipso/js');
    ...
    mix.sass('resources/assets/sass/bootstrap/app.scss',destCss +'bootstrap.min.css');

    mix.sass('resources/assets/sass/sweetalert/sweetalert2.scss',destCss +'pages/sweet_alert.css');
    ...
    mix.styles(
        [   
            'public/assets/vendors/bootstrap-tour/css/bootstrap-tour-standalone.css',
    ...
    mix.js('resources/assets/js/admire.js', destJs + 'custom.js');
